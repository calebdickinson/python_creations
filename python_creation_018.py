"""
Choose Your Own Adventure Story Window 5#
"""
...
PATH = "C:/Users/CALEB DICKINSON/Pictures/Saved Pictures/Burbon Road.png"
img = ImageTk.PhotoImage(Image.open(PATH))
panel = tk.Label(window, image=img)
panel.pack(side="bottom", fill="both", expand="yes")
x = tk.Label(
    window, text="You begin your journey down Burbon Road. "
