"""
Choose Your Own Adventure Story Window 6#
"""
...
PATH = "C:/Users/CALEB DICKINSON/Pictures/Saved Pictures/Icicle Road.png"
img = ImageTk.PhotoImage(Image.open(PATH))
panel = tk.Label(window, image=img)
panel.pack(side="bottom", fill="both", expand="yes")
x = tk.Label(
    window, text="You begin your journey down Icicle Road. "
