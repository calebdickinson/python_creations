...
def _window2():
    ...
    path_music2 = (
        "C:/Users/CALEB DICKINSON/Downloads/"
        "Chittyville Road.mp3"
    )
    playsound(path_music2, block=False)
    path_img2 = (
        "C:/Users/CALEB DICKINSON/Pictures/Saved Pictures/Chittyville Road.png"
    )
    img2 = ImageTk.PhotoImage(Image.open(path_img2))
    ...
    z1_2 = tk.Button(y_2, text="Walk")
    z2_2 = tk.Button(y_2, text="Bike")
    z3_2 = tk.Button(y_2, text="Drive")
...
def _window3():
    ...
    playsound(path_music3, block=False)
    path_img3 = (
        "C:/Users/CALEB DICKINSON/Pictures/Saved Pictures/Paplau Road.png"
    )
    img3 = ImageTk.PhotoImage(Image.open(path_img3))
...
def _window4():
    ...
    playsound(path_music4, block=False)
    path_img4 = (
        "C:/Users/CALEB DICKINSON/Pictures/Saved Pictures/Vizinni Road.png"
    )
    img4 = ImageTk.PhotoImage(Image.open(path_img4))
...
def _window5():
    ...
    playsound(path_music5, block=False)
    path_img5 = (
        "C:/Users/CALEB DICKINSON/Pictures/Saved Pictures/Burbon Road.png"
    )
    img5 = ImageTk.PhotoImage(Image.open(path_img5))
...
def _window6():
    ...
    playsound(path_music6, block=False)
    path_img6 = (
        "C:/Users/CALEB DICKINSON/Pictures/Saved Pictures/Icicle Road.png"
    )
    img6 = ImageTk.PhotoImage(Image.open(path_img6))
...
z1_1 = tk.Button(
    y_1, text="Chittyville Road",
    command=lambda: [_window1.destroy(), _window2()]
)
z2_1 = tk.Button(
    y_1, text="Paplau Road",
    command=lambda: [_window1.destroy(), _window3()]
)
z3_1 = tk.Button(
    y_1, text="Vizinni Road",
    command=lambda: [_window1.destroy(), _window4()]
)
z4_1 = tk.Button(
    y_1, text="Burbon Road",
    command=lambda: [_window1.destroy(), _window5()]
)
z5_1 = tk.Button(
    y_1, text="Icicle Road",
    command=lambda: [_window1.destroy(), _window6()]
)
